...
public class SimpleInput
{
    ...
    static final String CHOICE_TITLE = "Wahl trefen";
    ...
    **/
    ...
    public int getChoice(String prompt, int choices){
        Object[] commentArray = {prompt, EMPTY_STRING};
        boolean validResponse = false;
        int result = -1;
        ...
        while(!validResponse)
        {
            Object[] options = new Object[choices];
            ...
            if(result != -1)
                ...
                commentArray[1] = "Incorrect selection";
        }
        return result+1;
    }
}